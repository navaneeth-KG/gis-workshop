...
map.getView().fit([8562435.959181, 945668.703886, 8570506.746812, 950987.714077], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">webmap</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (38 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'this is a webmap generated by qgis2web';
            }
